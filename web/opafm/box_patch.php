...
$htm.='<button class="btn btn-sm btn-primary" id=btnAlgorithm>Algorithm #1</button>';
/*
...
$htm.='<div class="col-sm-3 col-lg-2">';//Volume
$htm.='<div class="form-group">';
...
$htm.='<div class="col-sm-3 col-lg-2">';//Pan
$htm.='<div class="form-group">';
...
$btns[]='<a href=#btn class="btn btn-sm btn-default" id=btnOpenXML title="Load xml patch"><i class="fa fa-folder-open-o"></i>XML</a>';
