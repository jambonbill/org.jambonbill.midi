...
$htm.='<select class=form-control id=algorithm>';
for($i=1;$i<13;$i++){
...
$btns=[];
$btns[]='<div class=row>';
$btns[]='<div class="col-xs-3">';
$btns[]='<div class="btn-group">';
$btns[]='<a href=#btn class="btn btn-default" id=btnNew title="New patch"><i class="fa fa-file-o"></i></a>';
